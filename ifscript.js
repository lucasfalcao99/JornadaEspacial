...
//Vetor 04
function vetor4(px1,py1,px2,py2,linha,cor){
	ctx.beginPath();
	ctx.moveTo(px1, py1);
	ctx.lineTo(px2, py2);
	ctx.lineWidth = linha;
	...
	ctx.beginPath();
	var l = 20;
	var ang = (Math.atan2(py2-py1,px2-px1)*Math.PI/180);
	ctx.moveTo(px2,py2);
	ctx.lineTo(px2+l*Math.cos(30*Math.PI/180-ang),py2+l*Math.sin(30*Math.PI/180-ang));
	ctx.lineTo(px2+l*Math.cos(60*Math.PI/180-ang),py2+l*Math.sin(60*Math.PI/180-ang));
	ctx.closePath();
	ctx.fillStyle = cor;
	ctx.fill();	
	//
...
//ESCALA GRADUADA NO EIXO XM
function escalagraduadaXM(x0,y0,tamanho,valorinicial,passo,cor){
	var valor = valorinicial;
	var i;	
	for (i=0;i<=tamanho;i++){		
		escrever8(valor,x0 + i*passo,y0,cor);	
		valor = valor + passo;
	}
}
...
//VETOR 03
function vetor3(x0,y0,modulo,cor,rotacao,mult){
	var setaw = 10*mult;
	var setah = 10*mult;
	ctx.save();
	ctx.translate(x0,y0);
	...
	ctx.lineTo(x0 + modulo/2 - setaw, y0 - setah/2);
	ctx.lineTo(x0 + modulo/2 - setaw, y0 + setah/2);
	ctx.fillStyle= cor;
	ctx.closePath();
	ctx.fill();	    
...
//SISTEMA DE EIXOS 1º QUADRANTE
function sistemaeixo(x0,y0,modulo1,modulo2,legenda1,tamanho1,fonte1,legenda2,tamanho2,fonte2,cor){
	//Linha horizontal
	ctx.beginPath()
	ctx.moveTo(x0,y0);
	ctx.lineTo(x0 + modulo1-2, y0);
	ctx.lineWidth = 2;
	ctx.strokeStyle= cor;
	ctx.stroke();
	//Seta horizontal	
	ctx.beginPath()		
	ctx.moveTo(x0 + modulo1, y0);
	ctx.lineTo(x0 + modulo1 - 10, y0 - 5);
	ctx.lineTo(x0 + modulo1 - 10, y0 + 5);
	ctx.fillStyle= cor;
	ctx.closePath();
	ctx.fill();
	...
	ctx.beginPath()
	ctx.moveTo(x0, y0);
	ctx.lineTo(x0, y0 - modulo2+2);
	ctx.lineWidth = 2;
	ctx.strokeStyle= cor;
	ctx.stroke();
	//Seta vertical	
	ctx.beginPath()		
	ctx.moveTo(x0, y0 - modulo2);
	ctx.lineTo(x0 + 5, y0 - modulo2 + 10);
	ctx.lineTo(x0 - 5, y0 - modulo2 + 10);
	ctx.fillStyle= cor;
	ctx.closePath();
	ctx.fill();
	//LEGENDA 1
	ctx.font = 'bold ' + tamanho1 + 'pt ' +  fonte1;
	ctx.fillStyle = cor;
	ctx.fillText(legenda1, x0 + modulo1, y0+20);
	//LEGENDA 2
	ctx.font = 'bold ' + tamanho2 + 'pt ' +  fonte2;
	ctx.fillStyle = cor;
	ctx.fillText(legenda2, x0-20, y0 - modulo2-10);
}		
...
function nave(x0,y0, esquerda, direita){
	...
	ctx.stroke();
	//
	retangulo(x0 - dx - 2,y0 - dy - 8,12,5,'rgba(255,0,0)','yellow',0)
	retangulo(x0 - dx - 2,y0 + dy + 3,12,5,'rgba(255,0,0)','yellow',0)
	retangulo(x0 - dx + 30,y0 - dy - 8,12,5,'rgba(255,0,0)','yellow',0)
	retangulo(x0 - dx + 30,y0 + dy + 3,12,5,'rgba(255,0,0)','yellow',0)
	octagono(x0,y0,7,5);
	//
	if(esquerda == 0.5){			
		chama(x0 - 23,y0 + 18, 0.3,-45);
		chama(x0 - 23,y0 - 13, 0.3,-45);
	}
	if(direita == 0.5){				
		chama(x0 + 23,y0 + 13, 0.3,45);
		chama(x0 + 23,y0 - 18, 0.3,45);
